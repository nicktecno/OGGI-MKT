...
export const MOCK_BEACHES: Beach[] = [
  {
    ...
    imageUrl: "/beaches/copacabana.jpg",
...
export const MOCK_PRODUCTS: BeachProduct[] = [
  {
    ...
    price: 8.9,
    imageUrl: "/loslos/products/sorvete-morango.jpg",
    category: "sorvete",
    disponivel: true,
  },
  {
    ...
    price: 8.9,
    imageUrl: "/loslos/products/sorvete-chocolate.jpg",
    category: "sorvete",
    disponivel: true,
  },
  {
    ...
    price: 7.9,
    imageUrl: "/loslos/products/sorvete-baunilha.jpg",
    category: "sorvete",
    disponivel: true,
  },
  {
    ...
    price: 6.9,
    imageUrl: "/loslos/products/picole-frutas.jpg",
    category: "picolé",
    disponivel: true,
  },
  {
    ...
    price: 5.9,
    imageUrl: "/loslos/products/picole-limao.jpg",
    category: "picolé",
    disponivel: true,
  },
  {
    ...
    price: 12.9,
    imageUrl: "/loslos/products/agua-coco.jpg",
    category: "bebida",
    disponivel: true,
  },
  {
    ...
    price: 9.9,
    imageUrl: "/loslos/products/suco-laranja.jpg",
    category: "bebida",
    disponivel: true,
  },
];
