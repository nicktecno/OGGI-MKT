      ...
      {order.status === "ACEITO" && ambulante && (
        <Card>
          ...
          <CardContent className="space-y-4">
            ...
            <div className="bg-gray-100 rounded h-32 flex items-center justify-center text-sm text-muted-foreground">
              🗺️ Mapa em tempo real (Fase 2 com WebSocket)
            </div>
          </CardContent>
        </Card>
      )}
        ...
        <CardContent className="space-y-2">
          ...
          <div className="pt-2 border-t">
            <div className="flex justify-between font-bold">
              <span>Total:</span>
              <span className="text-pink-600">R$ {order.totalPrice.toFixed(2)}</span>
            </div>
          </div>
        </CardContent>
      </Card>
