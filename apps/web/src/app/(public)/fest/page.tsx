...
export const metadata: Metadata = {
  title: "Montar pedido",
  description: `Escolha o carrinho Oggi Fest e as linhas de sorvete — ${SITE_NAME}.`,
};

export default function FestPage() {
  return (
    <main className="pb-24">
      <div className="border-b-4 border-primary bg-primary">
        <div className="relative mx-auto max-w-7xl overflow-hidden px-6 py-12 md:py-16">
          <div className="relative z-10 max-w-xl">
            <OggiHeading
              ...
              subtitle={`Pedido mínimo de ${formatBrl(OGGI_FEST_MIN_ORDER_BRL)} em picolés. Locação do carrinho sem custo adicional acima desse valor.`}
            />
          </div>
      ...
      <div className="mx-auto max-w-7xl px-6 py-14">
        <div className="grid gap-8 md:grid-cols-2">
          {FEST_CART_MODELS.map((cart) => (
            <article key={cart.id} className="oggi-card flex flex-col">
              ...
              <div className="flex flex-1 flex-col border-t-2 border-primary/10 p-6">
        ...
        <section className="mt-20 rounded-2xl bg-oggi-pink-light p-8 md:p-10" aria-labelledby="linhas-heading">
          <OggiHeading
            eyebrow="Produtos Oggi"
            title="Linhas de sorvete"
            subtitle="No próximo passo você distribui as unidades por linha ou aplica um modelo."
          />
