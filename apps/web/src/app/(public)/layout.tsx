  ...
  return (
    <div className="flex min-h-screen flex-col">
      <header className="sticky top-0 z-40 border-b border-border/60 bg-background/80 backdrop-blur-xl backdrop-saturate-150">
        <div className="mx-auto flex min-h-[4rem] max-w-7xl flex-col gap-3 px-5 py-3 sm:min-h-[4.25rem] sm:flex-row sm:items-center sm:justify-between sm:gap-4 sm:py-0 sm:px-8 lg:px-12">
          <Link href="/" className="group flex shrink-0 flex-col justify-center gap-0.5 sm:py-1">
            <span className="font-serif text-xl font-normal tracking-[0.01em] text-foreground transition-colors group-hover:text-foreground/85 sm:text-2xl">
              {SITE_NAME}
            </span>
            <span className="text-[0.625rem] font-medium uppercase tracking-[0.32em] text-muted-foreground">
              Moda artesanal
            </span>
          </Link>
      ...
      <footer className="border-t border-foreground/[0.08] bg-muted/25">
        <div className="mx-auto max-w-7xl px-5 py-14 sm:px-8 lg:px-12">
          <div className="flex flex-col items-center gap-6 text-center sm:flex-row sm:items-start sm:justify-between sm:text-left">
            <div>
              <p className="font-serif text-xl text-foreground/90">{SITE_NAME}</p>
              <p className="mt-1 text-[0.625rem] uppercase tracking-[0.28em] text-muted-foreground">Curadoria &amp; ofício</p>
            </div>
