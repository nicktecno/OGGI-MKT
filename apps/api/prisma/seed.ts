...
async function main() {
  ...
  const fornecedor = await prisma.platformAccount.create({
    data: {
      ...
      role: 'SUPPLIER',
      status: 'ACTIVE',
      fiscalDocumentKind: 'CNPJ',
      fiscalDocument: '11222333000181',
      termsAcceptedAt: new Date('2026-01-01T12:00:00.000Z'),
